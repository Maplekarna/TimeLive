package com.laioffer.twitchdemo;
...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.laioffer.twitchdemo.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "shuai-database.ctmqc7pqefhp.us-east-2.rds.amazonaws.com";
        String USERNAME = "maplekarna";
        String PASSWORD = "fsftx942901";
